...
public class StackDemo {
	...
	public static void main(String[] args) {
		...
		Stack<Car> myStack3=new Stack<>(); //bunu car a getter setter constructor lari yapinca koyabilirsin
		myStack3.push(new Car());
		myStack3.push(new Car("Ford",2000));
		myStack3.push(new Car("Gm",1997));
